...
bool cpm1(student x,student y)
{
    return x.score > y.score;
}

bool cpm2(student x,student y)
{
    return x.score < y.score;
}
...
int main()
{
    ...
    cin >> n;
    vector<student> s(n);
    for(int i = 0;i < n;i ++) cin >> s[i].name >> s[i].date >> s[i].score;
    sort(s.begin(),s.end(),cpm1);
    cout << s[0].name << ' ' << s[0].date << endl;
    sort(s.begin(),s.end(),cpm2);
    cout << s[0].name << ' ' << s[0].date << endl;
}
